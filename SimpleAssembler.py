...
=======
import sys
>>>>>>> 3c4e98fcfef349feae2928f338a395eafa773cd2
...
vardict={}
for sentence in ins:
    if sentence[0]!="var" or sentence[0]!=None: #error line
        count+=1
>>>>>>> 3c4e98fcfef349feae2928f338a395eafa773cd2
count=bin(count)
count=count[2:]
...
<<<<<<< HEAD
                ...
                if index==0:
                    tempout+=str("00")
=======
                        print(binlist[index][binfind],end="")
                if index==0:
                    print("00",end="")
>>>>>>> 3c4e98fcfef349feae2928f338a395eafa773cd2
                    word+=1
...
=======
                                print("\nFlag is used as Register")
                                quit()
                            print(dict_reg[reg],end="")
                            word+=1
                            break
                        if sentence[word] not in dict_reg:
                            print("\nRegister Error\n")
...
=======
                    ...
                    for var in vardict:
                        if var==sentence[word]:
                            print(vardict[var],end="")
                            break
                        if sentence[word] not in vardict:
                            if sentence[word] in labeldict:
                                print("\nMisused Label as Variable\n")
                                quit()
                    ...
                    for addr in labeldict:
                        if sentence[word]==addr:
                            print(labeldict[addr],end="")
                            break
                        if sentence[word] not in labeldict:
                            if sentence[word] in vardict:
                                print("\nMisused Valiable as Label\n")
                                quit()
                            print("\nLabel Not Defined\n")
                            quit()
                    word+=1
...
=======
                ...
                print("Variable not defined at start")
>>>>>>> 3c4e98fcfef349feae2928f338a395eafa773cd2
                quit()
            else:
